...
exports.config = {
    ...
    sync: true,
    specs: [
        './test/pinup/landing/register-email.ts'
    ],
    // Patterns to exclude.
    exclude: [
    ...
    //----Enable this if you need onli chrome service
  ...
  onPrepare: () => {
     ...
     */
     beforeTest: function (test) {    
        browser.addCommand("waitForTextApper", function({
          selector,
          text,
          timeout,
          timeoutMsg,
          interval
            ...
            browser.waitUntil(function(){
                try {
                    let txtActual = $(selector).getText()
